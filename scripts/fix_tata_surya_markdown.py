...
- **Hukum I Kepler (Hukum Lintasan Elips):** Setiap planet bergerak dalam orbit yang berbentuk elips, bukan lingkaran sempurna, dengan Matahari bertindak sebagai salah satu titik fokusnya (*foci*).
- **Hukum II Kepler (Hukum Kesamaan Luas):** Vektor radius khayal yang menghubungkan pusat planet ke Matahari menyapu luasan sektor elips yang sama dalam selang waktu yang sama. Akibatnya, kecepatan orbit planet tidak konstan: bergerak paling cepat saat mendekati titik terdekat dengan Matahari (**perihelion**) dan bergerak paling lambat saat berada di titik terjauh (**aphelion**).
- **Hukum III Kepler (Hukum Periode Harmonik):** Kuadrat periode revolusi suatu planet berbanding lurus dengan pangkat tiga jarak rata-rata sumbu semi-mayor lintasannya dari Matahari:

> **Formulasi Rasio Harmonik Kepler:**
> **(T₁)² / (a₁)³ = (T₂)² / (a₂)² = Konstanta**
> *(Keterangan: T = periode orbit revolusi planet, a = jarak rata-rata sumbu semi-mayor ke Matahari)*
...
conn.commit()
print("Fixed markdown parsing and code block unclosed fence error!")
