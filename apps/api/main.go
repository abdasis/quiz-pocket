...
func seedDatabase(db *gorm.DB) {
	...
	questions := []Question{
		// SD Level (1-20) - 10 Poin per soal
		...
		// SMP Level (21-40) - 20 Poin per soal
		{CategoryID: catSMP.ID, Question: "Selat yang memisahkan Pulau Jawa dan Sumatera adalah?", Options: `["Selat Malaka", "Selat Sunda", "Selat Bali", "Selat Makassar"]`, AnswerIndex: 1, Explanation: "Selat Sunda menghubungkan Laut Jawa dan Samudra Hindia.", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Naskah proklamasi kemerdekaan RI dibacakan di Jalan?", Options: `["Pegangsaan Timur No. 56", "Imam Bonjol No. 1", "Merdeka Barat", "Salemba Raya"]`, AnswerIndex: 0, Explanation: "Dibacakan di Jalan Pegangsaan Timur No. 56, Jakarta Pusat.", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Mengapa rel kereta api diberi celah pada sambungannya?", Options: `["Redam suara", "Ruang pemuaian saat panas", "Mempermudah perbaikan", "Anti slip"]`, AnswerIndex: 1, Explanation: "Celah memberi ruang muai agar rel tidak melengkung saat terik panas.", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Danau vulkanik terbesar di Asia Tenggara adalah?", Options: `["Danau Singkarak", "Danau Poso", "Danau Toba", "Danau Matano"]`, AnswerIndex: 2, Explanation: "Danau Toba di Sumatera Utara adalah danau kaldera vulkanik terbesar.", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Hukum Newton yang menyatakan aksi sama dengan reaksi berlawanan arah adalah?", Options: `["Hukum Newton I", "Hukum Newton II", "Hukum Newton III", "Hukum Archimedes"]`, AnswerIndex: 2, Explanation: "Hukum Newton III: F aksi = -F reaksi.", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Organ tubuh yang berfungsi menyaring racun dan memproduksi cairan empedu adalah?", Options: `["Pankreas", "Hati (Liver)", "Ginjal", "Limpa"]`, AnswerIndex: 1, Explanation: "Hati menyaring racun dari darah dan menghasilkan empedu untuk pencernaan lemak.", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Pemberontakan VOC di Jawa yang dipimpin Pangeran Diponegoro terjadi pada tahun?", Options: `["1800-1805", "1825-1830", "1901-1905", "1942-1945"]`, AnswerIndex: 1, Explanation: "Perang Jawa (Diponegoro) berlangsung dari tahun 1825 hingga 1830.", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Lapisan atmosfer bumi tempat terjadinya fenomena cuaca seperti hujan dan awan adalah?", Options: `["Troposfer", "Stratosfer", "Mesosfer", "Termosfer"]`, AnswerIndex: 0, Explanation: "Troposfer adalah lapisan atmosfer paling bawah tempat semua fenomena cuaca terjadi.", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Rumus luas permukaan lingkaran dengan jari-jari r adalah?", Options: `["2 × π × r", "π × r²", "4 × π × r²", "½ × π × r"]`, AnswerIndex: 1, Explanation: "Luas lingkaran dihitung dengan rumus π × r².", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Jenis batuan yang terbentuk dari pembekuan magma atau lava yang keluar dari gunung berapi adalah?", Options: `["Batuan Sedimen", "Batuan Beku", "Batuan Metamorf", "Batuan Kapur"]`, AnswerIndex: 1, Explanation: "Batuan beku (igneous rock) terbentuk dari pendinginan magma atau lava.", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Organ pernapasan manusia tempat terjadinya pertukaran oksigen dan karbon dioksida adalah?", Options: `["Trakea", "Bronkus", "Alveolus", "Laring"]`, AnswerIndex: 2, Explanation: "Alveolus adalah gelembung udara di paru-paru tempat difusi O2 dan CO2.", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Pegunungan tertinggi di dunia yang memiliki puncak Gunung Everest adalah?", Options: `["Pegunungan Andes", "Pegunungan Rocky", "Pegunungan Himalaya", "Pegunungan Alpen"]`, AnswerIndex: 2, Explanation: "Pegunungan Himalaya membentang di Asia dan memiliki puncak tertinggi Everest (8.848 m).", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Berapa kecepatan cahaya dalam ruang hampa secara pendekatan?", Options: `["300.000 m/detik", "300.000 km/detik", "3.000 km/detik", "30.000 km/jam"]`, AnswerIndex: 1, Explanation: "Kecepatan rambat cahaya di ruang hampa adalah sekitar 3 × 10^8 m/s (300.000 km/detik).", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Prasasti Yupa dari Kerajaan Kutai di Kalimantan Timur ditulis menggunakan huruf?", Options: `["Hieroglif", "Pallawa", "Kawi", "Latin"]`, AnswerIndex: 1, Explanation: "Prasasti Kerajaan Kutai menggunakan huruf Pallawa dan bahasa Sanskerta.", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Senyawa kimia garam dapur yang sering digunakan memasak memiliki rumus molekul?", Options: `["H2O", "NaCl", "CO2", "CaCO3"]`, AnswerIndex: 1, Explanation: "Garam dapur adalah Natrium Klorida (NaCl).", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Gunung tertinggi di pulau Jawa adalah?", Options: `["Gunung Merapi", "Gunung Semeru", "Gunung Bromo", "Gunung Slamet"]`, AnswerIndex: 1, Explanation: "Gunung Semeru (Puncak Mahameru) setinggi 3.676 mdpl adalah puncak tertinggi di Jawa.", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Energi yang tersimpan pada suatu benda karena kedudukan atau ketinggiannya disebut?", Options: `["Energi Kinetik", "Energi Potensial", "Energi Kimia", "Energi Panas"]`, AnswerIndex: 1, Explanation: "Energi Potensial Gravitasi (Ep = m × g × h) bergantung pada posisi/ketinggian benda.", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Batas laut teritorial Indonesia yang diakui secara internasional sejauh berapa mil laut dari garis pantai?", Options: `["3 Mil", "12 Mil", "24 Mil", "200 Mil"]`, AnswerIndex: 1, Explanation: "Batas laut teritorial Indonesia adalah 12 mil laut dari garis pangkal kepulauan.", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Pembelahan sel pada tubuh untuk pertumbuhan dan perbaikan jaringan tubuh yang rusak disebut?", Options: `["Mitosis", "Meiosis", "Amitosis", "Fertilisasi"]`, AnswerIndex: 0, Explanation: "Mitosis menghasilkan 2 sel anakan identik untuk perbanyakan dan perbaikan sel tubuh.", Level: "SMP", Points: 20},
		{CategoryID: catSMP.ID, Question: "Titik beku air murni pada tekanan standar 1 atmosfer berada pada suhu?", Options: `["0° Celcius", "32° Celcius", "100° Celcius", "-4° Celcius"]`, AnswerIndex: 0, Explanation: "Air murni membeku pada suhu 0°C dan mendidih pada 100°C.", Level: "SMP", Points: 20},

		// SMA Level (41-60) - 30 Poin per soal
		{CategoryID: catSMA.ID, Question: "Kenaikan harga barang dan jasa secara umum dan terus menerus disebut?", Options: `["Deflasi", "Inflasi", "Devaluasi", "Resesi"]`, AnswerIndex: 1, Explanation: "Inflasi menurunkan daya beli uang terhadap barang dan jasa.", Level: "SMA", Points: 30},
		{CategoryID: catSMA.ID, Question: "Mengapa rem kendaraan panas saat menuruni jalan pegunungan curam?", Options: `["Gesekan ubah energi kinetik jadi panas", "Udara tipis", "Gravitasi rusak rem", "Minyak rem menguap"]`, AnswerIndex: 0, Explanation: "Energi kinetik laju roda diubah menjadi energi termal (panas) akibat gesekan kampas.", Level: "SMA", Points: 30},
		{CategoryID: catSMA.ID, Question: "Metode budgeting yang membagi 50% Kebutuhan, 30% Keinginan, 20% Tabungan disebut?", Options: `["Pareto 80/20", "Metode 50/30/20", "Aturan 70/20/10", "Zero-Based"]`, AnswerIndex: 1, Explanation: "Metode 50/30/20 dirancang untuk menjaga alokasi pendapatan ideal.", Level: "SMA", Points: 30},
		{CategoryID: catSMA.ID, Question: "Gas rumah kaca utama buangan pembakaran fosil pemicu pemanasan global adalah?", Options: `["O2", "CO2", "He", "N2"]`, AnswerIndex: 1, Explanation: "Karbon Dioksida (CO2) adalah kontributor terbesar efek rumah kaca buatan manusia.", Level: "SMA", Points: 30},
		{CategoryID: catSMA.ID, Question: "Mengapa tubuh lebih mudah mengapung di air laut dibanding air tawar?", Options: `["Massa jenis air laut lebih besar", "Suhu lebih hangat", "Dorongan ombak", "Tekanan udara rendah"]`, AnswerIndex: 0, Explanation: "Gaya apung Archimedes sebanding dengan densitas cairan. Air laut lebih padat.", Level: "SMA", Points: 30},
		{CategoryID: catSMA.ID, Question: "Penurunan nilai mata uang domestik terhadap mata uang asing akibat kebijakan pemerintah disebut?", Options: `["Apresiasi", "Depresiasi", "Devaluasi", "Revaluasi"]`, AnswerIndex: 2, Explanation: "Devaluasi adalah kebijakan penurunan resmi nilai mata uang terhadap mata uang asing.", Level: "SMA", Points: 30},
		...
		{CategoryID: catSMA.ID, Question: "Instrumen investasi pasar modal yang menunjukkan bukti kepemilikan sebagian atas suatu perusahaan adalah?", Options: `["Obligasi", "Saham", "Deposito", "Surat Utang Negara"]`, AnswerIndex: 1, Explanation: "Saham merupakan bukti penyertaan modal atau kepemilikan atas sebuah perseroan.", Level: "SMA", Points: 30},
		{CategoryID: catSMA.ID, Question: "Organel sel yang sering disebut 'pembangkit tenaga sel' (powerhouse of cell) adalah?", Options: `["Ribosom", "Mitokondria", "Lisosom", "Badan Golgi"]`, AnswerIndex: 1, Explanation: "Mitokondria menghasilkan sebagian besar pasokan adenosin trifosfat (ATP) sebagai energi sel.", Level: "SMA", Points: 30},
		{CategoryID: catSMA.ID, Question: "Prinsip ekonomi yang menyatakan bahwa semakin banyak barang diproduksi, semakin rendah biaya rata-rata per unit disebut?", Options: `["Opportunity Cost", "Economies of Scale (Skala Ekonomis)", "Law of Diminishing Return", "Invisble Hand"]`, AnswerIndex: 1, Explanation: "Skala ekonomis terjadi ketika efisiensi biaya tercapai seiring peningkatan volume produksi.", Level: "SMA", Points: 30},
		{CategoryID: catSMA.ID, Question: "Mengapa langit siang hari terlihat berwarna biru?", Options: `["Pantulan warna air laut", "Hamburan Rayleigh cahaya matahari oleh partikel udara", "Lapisan ozon berwarna biru", "Matahari memancarkan sinar biru saja"]`, AnswerIndex: 1, Explanation: "Hamburan Rayleigh menyebabkan gelombang cahaya berfrekuensi tinggi (biru) terhambur ke segala arah.", Level: "SMA", Points: 30},
		{CategoryID: catSMA.ID, Question: "Biaya yang timbul karena memilih satu alternatif terbaik dan mengorbankan alternatif lainnya dinamakan?", Options: `["Biaya Tetap", "Biaya Peluang (Opportunity Cost)", "Biaya Marginal", "Biaya Variabel"]`, AnswerIndex: 1, Explanation: "Opportunity cost adalah nilai dari potensi manfaat yang hilang ketika memilih satu opsi atas opsi lain.", Level: "SMA", Points: 30},
		{CategoryID: catSMA.ID, Question: "Zat pengawet alami yang sering digunakan dalam proses pengasapan atau pembuatan ikan asin adalah?", Options: `["Formalin", "Garam (NaCl)", "Boraks", "Tawas"]`, AnswerIndex: 1, Explanation: "Garam menyerap air dari sel bakteri melalui osmosis sehingga mikroba perusak tidak bisa berkembang.", Level: "SMA", Points: 30},
		{CategoryID: catSMA.ID, Question: "Hukum termodinamika yang menyatakan bahwa energi tidak dapat diciptakan atau dimusnahkan adalah?", Options: `["Hukum Termodinamika I", "Hukum Termodinamika II", "Hukum Termodinamika III", "Hukum Termodinamika Ke-Nol"]`, AnswerIndex: 0, Explanation: "Hukum I Termodinamika adalah hukum kekekalan energi (energi hanya dapat berubah bentuk).", Level: "SMA", Points: 30},
		{CategoryID: catSMA.ID, Question: "Kondisi di mana pertumbuhan ekonomi stagnan atau melambat disertai dengan tingkat inflasi yang tinggi disebut?", Options: `["Stagflasi", "Hiperinflasi", "Deflasi", "Depresi Ekonomi"]`, AnswerIndex: 0, Explanation: "Stagflasi merupakan gabungan dari stagnansi pertumbuhan ekonomi dan inflasi tinggi.", Level: "SMA", Points: 30},
		{CategoryID: catSMA.ID, Question: "Mengapa saat menyetir di jalan beraspal panas di kejauhan tampak seperti ada genangan air (fatamorgana)?", Options: `["Pembiasan cahaya akibat perbedaan kerapatan udara panas dan dingin", "Halusinasi pengemudi", "Uap air mengembun di jalan", "Aspal mencair"]`, AnswerIndex: 0, Explanation: "Fatamorgana terjadi akibat pembiasan/refraksi cahaya matahari saat melewati lapisan udara dengan gradien suhu berbeda.", Level: "SMA", Points: 30},
		{CategoryID: catSMA.ID, Question: "Zat dalam tubuh yang berfungsi mempercepat reaksi kimia biologis tanpa ikut terpakai habis adalah?", Options: `["Enzim", "Hormon", "Lipid", "Glukosa"]`, AnswerIndex: 0, Explanation: "Enzim adalah biokatalisator yang mempercepat laju reaksi biologis di dalam organisme.", Level: "SMA", Points: 30},
